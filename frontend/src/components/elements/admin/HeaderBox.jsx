...
const HeaderBox = ({ dataDetail }) => {
  return (
    <div className="grid sm:grid-cols-3 md:grid-cols-3 gap-4  md:gap-2 lg:gap-10 mb-6">
      <div className="h-[100px] bg-white  p-4 sm:p-2 xl:p-4   rounded-md shadow-md border-r-4 border-b-4  border-blue-800">
      ...
      <div className="h-[100px] bg-white   p-4 sm:p-2 xl:p-4  rounded-md shadow-md border-r-4 border-b-4  border-purple-800">
        <div className="flex-between">
      ...
      <div className="h-[100px] bg-white   p-4 sm:p-2 xl:p-4  rounded-md border-b-4 border-r-4 border-pink-800">
        <div className="flex-between">
