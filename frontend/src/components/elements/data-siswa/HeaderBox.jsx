...
const HeaderBox = ({ dataDetail, loading }) => {
  return (
    <div className=" px-4 py-8 border border-gray-300 rounded-md  bg-white mb-6">
      <div className="grid sm:grid-cols-3 md:grid-cols-3 gap-4  md:gap-2 lg:gap-10 ">
        <div className=" bg-white flex flex-col justify-between p-4 sm:px-3 xl:p-5 h-[110px]  rounded-md shadow-md border-r-4 border-b-4 border-t border-l border-t-gray-100 border-l-gray-100  border-blue-800">
        ...
        <div className=" bg-white flex flex-col justify-between  p-4 sm:px-3 xl:p-5 h-[110px] rounded-md shadow-md border-r-4 border-b-4 border-t border-l border-t-gray-100 border-l-gray-100   border-purple-800">
          <div className="flex-between">
        ...
        <div className=" bg-white flex flex-col justify-between  p-4 sm:px-3 xl:p-5 h-[110px] rounded-md border-b-4 border-r-4 border-t border-l border-t-gray-100 border-l-gray-100 border-pink-800">
          <div className="flex-between">
