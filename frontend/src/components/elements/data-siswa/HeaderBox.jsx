...
const HeaderBox = ({ dataDetail, loading }) => {
  return (
    <div className="grid mb-6 sm:grid-cols-3 md:grid-cols-3 gap-4  md:gap-2 lg:gap-8 ">
      <div className=" bg-white flex items-center justify-between p-4 sm:px-3 xl:p-5 h-[85px]  rounded-md shadow-md border-r-4 border-t border-l border-t-gray-100 border-l-gray-100  border-blue-800">
      ...
      <div className=" bg-white flex items-center justify-between  p-4 sm:px-3 xl:p-5 h-[85px] rounded-md shadow-md border-r-4 border-t border-l border-t-gray-100 border-l-gray-100   border-purple-800">
        <div className="flex items-center gap-2">
      ...
      <div className=" bg-white flex items-center justify-between  p-4 sm:px-3 xl:p-5 h-[85px] rounded-md shadow-md border-r-4 border-t border-l border-t-gray-100 border-l-gray-100 border-pink-800">
        <div className="flex items-center gap-2">
