...
const EditModal = ({ onClose, kelas }) => {
  ...
  useEffect(() => {
    if (editData) {
      setValue("nis", editData.nis);
      setValue("namaKelas", editData.kelas.nama);
      setValue("kelas", editData.kelas.kelas);
      setValue("nama", editData.nama);
      setValue("tempatLahir", editData.tempatLahir);
      setValue("jenisKelamin", editData.jenisKelamin);
      setValue("tanggalLahir", formatDate(editData.tanggalLahir));
      setValue("tahunMasuk", editData.tahunMasuk);
      setValue("agama", editData.agama);
      setValue("phone", editData.phone);
      setValue("alamat", editData.alamat);
      setValue("password", undefined);
      setValue("_id", editData._id);
      setFoto(editData.photo);
    }
  }, [editData]);
